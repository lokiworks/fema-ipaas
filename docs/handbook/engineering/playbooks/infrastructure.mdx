...
|---|---|---|
| Staging | `stg.fema.local` | `mrsk/stg` |
| Production | `fema.local` | `mrsk/prod` |

Staging receives every merge to `main` and is promoted to production daily at 9 AM UTC. See the [Releases & Deployment](/handbook/engineering/playbooks/releases) playbook for the full workflow.
