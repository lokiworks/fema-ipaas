...
The template will deploy the latest Activepieces image that's available on [Docker Hub](https://hub.docker.com/r/lokiworks/fema-ipaas).
...
For a full list of all the currently available configuration options, take a look at the [Activepieces Pulumi template file on GitHub](https://github.com/lokiworks/fema-ipaas/tree/main/deploy/pulumi/Pulumi.yaml).
