...
icon: 'function'
description: "Transform and combine data inside any text input using data manipulation"
---
...
<img width="450" src="/resources/using-formulas-anatomy.png" alt="A function badge with function name, argument slots, and semicolon separators" />
...
You can mix plain text, mentions, and functions in the same input. The function's result replaces the badge when the workflow runs.
...
The workflow won't run a step whose function is in error — fix it before publishing.
