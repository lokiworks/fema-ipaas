...
const lines = ['| # | Connector | Raw (node_modules) | Bundled | Smaller |', '|--:|---|--:|--:|--:|']
ok.forEach((r, i) => {
...
console.log(`Connectors measured: ${ok.length} OK, ${failed.length} failed${failed.length ? ' (' + failed.map((r) => r.connectorName).join(', ') + ')' : ''}`)
