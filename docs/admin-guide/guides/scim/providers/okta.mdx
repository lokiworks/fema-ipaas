...
<Warning>
  Deleting a group will delete the whole project in FEMA Integration Platform with its flows and connections. Users linked to that group won't be affected.
</Warning>
