...
<Note>
This page is for *connector authors* deciding what version number to publish. For how flows adopt new connector versions, see [Connector syncing & versioning](/install/architecture/connector-syncing).
</Note>
