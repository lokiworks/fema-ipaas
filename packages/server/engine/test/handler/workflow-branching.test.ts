...
function executeBranchActionWithOneCondition(condition: BranchCondition): Promise<WorkflowExecutorContext> {
...
describe('workflow with branching different  branches', () => {
