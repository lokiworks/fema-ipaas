...
import { SyncConnectorsButton } from '@/app/routes/platform/setup/connectors/sync-connectors';
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full flex flex-col flex-1 min-h-0">
        {!platform.plan.manageConnectorsEnabled && (
