...
**Examples:**
- [New Record Airtable](https://github.com/lokiworks/fema-ipaas/blob/main/packages/connectors/community/airtable/src/lib/trigger/new-record.trigger.ts)
- [New Updated Item Salesforce](https://github.com/lokiworks/fema-ipaas/blob/main/packages/connectors/community/salesforce/src/lib/trigger/new-updated-record.ts)
...
```typescript
const polling: Polling<ConnectionValueForAuthProperty<typeof auth>, Record<string, never>> = {
...
```typescript
const polling: Polling<ConnectionValueForAuthProperty<typeof auth>, Record<string,any>> = {
