...
vi.mock(
  '@/app/routes/tenant/infra/health/components/daily-health-strip',
  () => ({ DailyHealthStrip: () => null }),
);

vi.mock('@/features/tenant-admin', () => ({
  healthQueries: {
...
import { SystemHealthTab } from '@/app/routes/tenant/infra/health/components/system-health-tab';
