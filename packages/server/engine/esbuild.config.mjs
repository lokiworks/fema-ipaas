...
function buildOptions({ outfile, entry = 'src/main.ts' }) {
  return {
    ...
    treeShaking: true,
    alias: {
        '@fema-ipaas/shared': path.resolve(__dirname, '../../core/shared/src'),
        '@fema-ipaas/connector-sdk': path.resolve(__dirname, '../../connectors/sdk/src'),
        '@fema-ipaas/connector-common': path.resolve(__dirname, '../../connectors/common/src'),
        '@fema-ipaas/core-utils': path.resolve(__dirname, '../../core/utils/src'),
        '@fema-ipaas/connector-types': path.resolve(__dirname, '../../core/connector-types/src'),
        '@fema-ipaas/expression': path.resolve(__dirname, '../../core/formula/src'),
        '@fema-ipaas/workflow-core': path.resolve(__dirname, '../../core/execution/src'),
    },
