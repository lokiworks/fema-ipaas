...
export type InputProperty =
  ...
  | DropdownProperty<any, boolean, ConnectorAuthProperty | undefined | ConnectorAuthProperty[]>
  | StaticDropdownProperty<any, boolean>
  | NumberProperty<boolean>
  | ArrayProperty<boolean>
  | ObjectProperty<boolean>
  | JsonProperty<boolean>
  | MultiSelectDropdownProperty<any, boolean, ConnectorAuthProperty | undefined | ConnectorAuthProperty[]>
  | StaticMultiSelectDropdownProperty<any, boolean>
  | DynamicProperties<boolean, ConnectorAuthProperty | ConnectorAuthProperty[] | undefined>
...
export const Property = {
  ...
  Dropdown<T, R extends boolean = boolean, ConnectorAuth extends ConnectorAuthProperty | ConnectorAuthProperty[] |  undefined = undefined>(
    request: Properties<DropdownProperty<T, R, ConnectorAuth>>
  ): R extends true ? DropdownProperty<T, true, ConnectorAuth> : DropdownProperty<T, false, ConnectorAuth> {
    return {
      ...request,
      valueSchema: undefined,
      type: PropertyType.DROPDOWN,
    } as unknown as R extends true
      ? DropdownProperty<T, true, ConnectorAuth>
      : DropdownProperty<T, false, ConnectorAuth>;
  },
  ...
  MultiSelectDropdown<T, R extends boolean = boolean, ConnectorAuth extends ConnectorAuthProperty | ConnectorAuthProperty[] | undefined = undefined>(
    request: Properties<MultiSelectDropdownProperty<T, R, ConnectorAuth>>
  ): R extends true
    ? MultiSelectDropdownProperty<T, true, ConnectorAuth>
    : MultiSelectDropdownProperty<T, false, ConnectorAuth> {
    return {
      ...request,
      valueSchema: undefined,
  ...
  DynamicProperties<R extends boolean = boolean, ConnectorAuth extends ConnectorAuthProperty | ConnectorAuthProperty[] | undefined = undefined>(
    request: Properties<DynamicProperties<R,ConnectorAuth>>
  ): R extends true ? DynamicProperties<true, ConnectorAuth> : DynamicProperties<false, ConnectorAuth> {
    return {
      ...request,
      valueSchema: undefined,
      type: PropertyType.DYNAMIC,
    } as unknown as R extends true
      ? DynamicProperties<true, ConnectorAuth>
      : DynamicProperties<false, ConnectorAuth>;
  },
