...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@fema-ipaas/connector-common': path.resolve(__dirname, '../../../packages/connectors/common/src/index.ts'),
      '@fema-ipaas/server-utils': path.resolve(__dirname, '../../../packages/server/utils/src/index.ts'),
      '@fema-ipaas/ai-providers': path.resolve(__dirname, '../../../packages/core/ai-providers/src/index.ts'),
