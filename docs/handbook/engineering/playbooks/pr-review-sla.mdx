...
| Path | Team | Members |
|------|------|---------|
| `*` (everything else) | `@fema/core` | Louai, Abdul, Hazem, Ahmad, Othman |
| `packages/connectors/` | `@fema/connectors` | Ahmad, Kishan, Sanket |
| `packages/server/engine/`, `packages/server/worker/`, `packages/core/execution/` | `@fema/platform` | Mohammad, Chaker, Amr |
