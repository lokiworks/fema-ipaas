...
function AutoFormFieldWrapper({
  ...
  const isArrayProperty =
    !isConnectorAuthProperty(property) && property.type === PropertyType.ARRAY;
...
export function getValueForInputOnDynamicToggleChange(
  property: ConnectorProperty | ConnectorAuthProperty[],
...
type AutoFormFielWrapperErrorBoundaryProps = {
  ...
  property: ConnectorProperty | ConnectorAuthProperty[] | null;
  dynamicInputModeToggled?: boolean;
};
...
function isConnectorAuthProperty(
  property: ConnectorProperty | ConnectorAuthProperty[],
): property is ConnectorAuthProperty[] {
