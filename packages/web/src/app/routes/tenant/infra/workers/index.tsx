            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                worker.workerGroupId ? (
                  ...
                  <Badge
                    variant={
                      worker.workerGroupScope === WorkerGroupScope.TENANT
                        ? 'success'
                        : 'secondary'
                    }
                  >
              ...
              <TooltipContent className="max-w-xs">
                ...
                worker.workerGroupId
                  ...
                  : worker.workerGroupScope === WorkerGroupScope.TENANT
                  ? t(
                      'This worker runs exclusively for your tenant with no sandboxing overhead.',
                    )
                  : t(
                      'This worker is shared across tenants and uses strict sandboxing for isolation.',
                    )}
              </TooltipContent>
            </Tooltip>
