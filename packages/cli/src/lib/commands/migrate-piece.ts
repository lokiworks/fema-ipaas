...
export const migratePieceCommand = new Command('migrate')
    .description('Migrate a piece to the self-contained bundle model: repoint imports to @fema/connector-sdk, fix package.json, and add the import-boundary lint rule')
