...
To test the AI provider, you can use a **universal AI** connector in a flow. Follow these steps:
...
- Create a flow that uses our **universal AI** connectors. And select **"Your AI Provider"** as the AI provider in the **Ask AI** action settings.
