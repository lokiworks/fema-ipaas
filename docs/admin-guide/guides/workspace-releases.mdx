...
Project Releases allow you to sync workflows, connections, and tables between different projects—essential for teams that want to develop in one environment and deploy to another with confidence.
...
| **Project** | Copy workflows from another project in your instance |
...
Apply changes from workflows, connections and tables in one project to another.
...
<Steps>
  ...
  <Step title="Select Source Project">
    Choose the project you want to copy workflows, connections and tables from.
  </Step>
...
<Steps>
  ...
  <Step title="Review Changes">
    ...
    - **Workflows Changes**: New, updated, or deleted workflows
    - **Connections Changes**: New or renamed connections
    - **Tables Changes**: New, updated, or deleted tables
  </Step>
  <Step title="Select Changes">
    Check or uncheck the workflows you want to include in this release.
  </Step>
...
If your project is connected to a Git repository, you can push all your workflows, connections, and tables to Git.
...
<Steps>
  ...
  <Step title="Push">
    Click **Push** to send all published workflows to the Git repository.
  </Step>
</Steps>
...
## Pushing Individual Workflows or Tables

You can also push specific workflows or tables to Git without pushing everything.
<Warning>
 You can only push published workflows to git
</Warning>
<Steps>
  <Step title="Select Items">
    Navigate to your workflows or tables and select the items you want to push.
  </Step>
...
![Push to Git Dialog](/resources/screenshots/push-workflows-to-git-1.png)

![Push to Git Dialog](/resources/screenshots/push-workflows-to-git-2.png)
...
- New workflows that will be created
- Existing workflows that will be updated
- Workflows that will be deleted
...
<AccordionGroup>
  ...
  <Accordion title="Push Everything button not visible">
    Make sure you configured your git settings and if you are selecting workflows, make sure they are published.
  </Accordion>
