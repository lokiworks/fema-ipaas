...
- **Piece bundles**: official tarballs served from the Activepieces CDN (`FEMA_USE_CDN_FOR_BUNDLES=true`)
...
```bash
FEMA_API_KEY=<key> npx @activepieces/cli@latest benchmark --url https://your-instance.example.com
```
