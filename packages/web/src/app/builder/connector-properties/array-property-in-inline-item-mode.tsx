...
type ArrayConnectorPropertyInInlineItemModeProps = BaseArrayPropertyProps &
  (
...
const ArrayConnectorPropertyInInlineItemMode = React.memo(
  (props: ArrayConnectorPropertyInInlineItemModeProps) => {
...
ArrayConnectorPropertyInInlineItemMode.displayName =
  'ArrayConnectorPropertyInInlineItemMode';
export { ArrayConnectorPropertyInInlineItemMode };
