...
**Testing:**
You cannot test it with Test Workflow, as it uses static sample data provided in the connector.
To test the trigger, publish the workflow, perform the event. Then check the workflow runs from the main dashboard.
