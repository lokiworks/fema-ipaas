...
Activepieces' **core** is released as open source under the [MIT license](https://github.com/lokiworks/fema-ipaas/blob/main/LICENSE) and enterprise / cloud editions features are released under [Commercial License](https://github.com/lokiworks/fema-ipaas/blob/main/packages/ee/LICENSE)
...
Using the enterprise features (under the packages/ee and packages/server/api/src/app/ee folder) with a self-hosted instance requires an Activepieces license. If you are looking for these features, contact us at [sales@fema.local](mailto:sales@fema.local).
