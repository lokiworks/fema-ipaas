...
The **FEMA Integration Platform engineering brain**: how the system works, and *why* it was built that way. Read this first, then jump to an Area. Written for both people and agents — every page names its topic, front-loads the point, and stands alone.
...
- 💾 [Data, Storage & Observability](https://craftspace.app/o/fema/pages/pg_vpiOe3lf7N9ox2XhxrJyH) — Tables, Files, KV, variables, audit logs, analytics.
