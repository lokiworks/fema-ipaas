import { GenericStepOutput, LoopStepOutput, RouterStepOutput, StepOutputStatus } from '../../../src/lib/execution/state/step-output'
...
describe('GenericStepOutput', () => {
    it('should create an instance with factory method', () => {
        ...
        expect(step.type).toBe(WorkflowActionType.CODE)
...
describe('RouterStepOutput', () => {
    it('init should create with ROUTER type and SUCCEEDED status', () => {
        ...
        expect(router.type).toBe(WorkflowActionType.ROUTER)
