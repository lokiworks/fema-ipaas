...
- Create a global connection for a project using the API in the tenant admin. Only tenant admins can edit or delete global connections.
...
<Steps>
  <Step title="Create an API Key">
    Go to **Tenant Admin → Security → API Keys** and create an API key. Save it for use in the next step.
...
const connectorName = '@fema-ipaas/connector-gelato';
