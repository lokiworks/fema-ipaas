...
### Entity
`AppConnection`: id, displayName, externalId (stable ref in flow settings, survives rename), type, status (ACTIVE/EXPIRED/ERROR), value (encrypted AES-256), platformId, connectorName/Version, projectIds[], scope (PROJECT/PLATFORM), preSelectForNewProjects.
