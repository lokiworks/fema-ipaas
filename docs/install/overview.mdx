...
title: "Overview"
icon: "hand-wave"
description: "Introduction to the different ways to install FEMA Integration Platform"
---

FEMA Integration Platform Community Edition can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.

<Tip>
Community Edition is **free** and **open source**.

You can read the difference between the editions [here](https://github.com/lokiworks/fema-ipaas/pricing).
</Tip>

<Note>
**Going to production?** Pick an install method below to get running, then read [Production Setup](./configure-operate/production-setup) — it's the one opinionated production shape, and every sizing choice workflows from a single number.
</Note>
...
Deploy FEMA Integration Platform as a single Docker container using the PGLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose">
    Deploy FEMA Integration Platform with **Redis** and **PostgreSQL** setup.
  </Card>
...
<CardGroup cols={2}>
  ...
  } href="https://www.pikapods.com/pods?run=fema">
...
<CardGroup cols={2}>
  <Card title="FEMA Integration Platform Cloud" icon="cloud" color="##5155D7" href="https://github.com/lokiworks/fema-ipaas/">
