...
function ConnectionSelect(params: ConnectionSelectProps) {
  ...
  const {
    ...
    name: params.connector.name,
    version: reconnectConnection?.connectorVersion ?? params.connector.version,
  });
  ...
  // from a project workflow must default to PROJECT scope, otherwise it silently
      ...
      render={({ field }) => (
        <>
          ...
          {!isLoadingConnections &&
            connectorWithCorrectVersion &&
            params.connector.auth && (
              <AutoFormFieldWrapper
                property={params.connector.auth}
                propertyName="auth"
                field={field}
              ...
              >
                <CreateOrEditConnectionDialog
                  ...
                  connector={connectorWithCorrectVersion}
