...
const INSTRUCTIONS_BLOCK = [
  ...
  '',
  '1. **Tenant / OAuth app issue (not user-fixable from the step settings).** Applies when ANY of:',
  ...
  '   In this case, say plainly that this looks like a tenant-side OAuth configuration issue, NOT a step setting. Suggest contacting tenant support OR (self-hosted) configuring custom OAuth credentials with the required scope.',
  '',
