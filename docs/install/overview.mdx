...
FEMA Integration Platform can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.

<Tip>
There is one edition. It is **free** and **open source**, and every capability ships in it — see [License](/about/license).
</Tip>
