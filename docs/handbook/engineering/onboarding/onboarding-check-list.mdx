...
- [ ] Set up your @fema.local email account and setup 2FA
- [ ] Confirm access to our private Discord server.
- [ ] Get Invited to the FEMA Integration Platform Github Organization and Setup 2FA
...
- [ ] Understand the key database tables (Platform, Projects, Workflows, Connections, Users)
...
Welcome again to the team. We can't wait to see the impact you'll make at FEMA Integration Platform! 😉
