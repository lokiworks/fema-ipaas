...
- `packages/server/api/src/app/ee/connections/platform-oauth2-service.ts` — the consumer, calls `getWithSecret` during token exchange
...
- `packages/web/src/app/routes/platform/setup/connectors/update-oauth2-dialog.tsx` — dialog for entering credentials
