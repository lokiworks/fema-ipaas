...
- **Image source:** Docker Hub `lokiworks/fema-ipaas`, one of the **3 most-recent tags**,
...
curl -s "https://hub.docker.com/v2/repositories/lokiworks/fema-ipaas/tags?page_size=50&ordering=last_updated" \
...
```
docker pull lokiworks/fema-ipaas:$TAG
...
grype lokiworks/fema-ipaas:$TAG --platform linux/amd64 -o json \
