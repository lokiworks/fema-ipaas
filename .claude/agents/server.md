---
name: server
description: Backend agent for the FEMA Integration Platform server API (packages/server/api). Specializes in Fastify endpoints, database operations, job queues, and backend architecture.
model: sonnet
tools:
  - Read
  - Edit
