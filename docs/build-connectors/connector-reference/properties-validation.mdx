...
FEMA Integration Platform uses Zod for runtime validation of connector properties. Zod provides a powerful schema validation system that helps ensure your connector receives valid inputs.

To use Zod validation in your connector, first import the validation helper and Zod:
...
```typescript
import { createAction, Property } from '@fema-ipaas/connectors-framework';
import { propsValidation } from '@fema-ipaas/connectors-common';
import { z } from 'zod';
