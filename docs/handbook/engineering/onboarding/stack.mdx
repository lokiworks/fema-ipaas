...
FEMA Integration Platform uses **Typescript** as its one and only language.
...
- Logging: [evlog](https://evlog.dev/) (structured wide events; OTLP log drain via FEMA_OTEL_ENABLED)
