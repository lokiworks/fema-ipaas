...
import { ExecutionMode, getPieceNameFromAlias, PackageType, PiecePackage, PieceType } from '@fema/shared'
...
// path such as `../../../common/pieces/@fema/connector-x` — fed in via stale `usedPieces` data
