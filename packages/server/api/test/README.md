...
- `mocks/index.ts` — ~850 LOC of factory builders (e.g., `createMockWorkflow`, `createMockWorkflowVersion`, `mockAndSaveBasicSetup`, `generateMockToken`) using `@faker-js/faker`.
