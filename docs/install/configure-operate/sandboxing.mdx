...
description: "Choose how workflow code is isolated and set FEMA_EXECUTION_MODE accordingly"
icon: "code"
---

Decide how workflow code is isolated before you go to production. Here is a simplified way to choose:
...
Set the mode with the `FEMA_EXECUTION_MODE` environment variable. The table below lists every mode and its exact value:
