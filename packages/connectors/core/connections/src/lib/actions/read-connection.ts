...
**Advanced Connector**
<br>
Use this connector if you are unsure which connection to use beforehand, such as when the connection external ID is sent through a webhook message.
