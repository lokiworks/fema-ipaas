...
| Input | Type | Required | Description |
|-------|------|----------|-------------|
| `connectorName` | string | Yes | Connector name (e.g., `@fema/connector-slack`) |
...
| Input | Type | Required | Description |
|-------|------|----------|-------------|
| `connectorName` | string | Yes | Connector name (e.g., `@fema/connector-google-sheets`) |
...
|-------|------|----------|-------------|
| `workflowId` | string | Yes | The workflow ID |
| `connectorName` | string | Yes | Connector name (e.g., `@fema/connector-gmail`) |
...
| Input | Type | Required | Description |
|-------|------|----------|-------------|
| `connectorName` | string | Yes | Connector name (e.g. `slack` or `@fema/connector-slack`). Use `ap_research_connectors` to discover. |
