...
Once the connection is saved, you can reference Vault secrets inside any connector connection dialog — in global connections (Platform Admin) or directly in the flow builder.
