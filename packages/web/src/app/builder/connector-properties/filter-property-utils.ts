...
function isFilterActive(
  property: ConnectorProperty | undefined,
  value: unknown,
): boolean {
...
function emptyValueFor(property: ConnectorProperty): unknown {
  switch (property.type) {
    case PropertyType.CHECKBOX:
      return false;
    case PropertyType.DATE_RANGE:
...
function chipLabel(property: ConnectorProperty, value: unknown): string {
