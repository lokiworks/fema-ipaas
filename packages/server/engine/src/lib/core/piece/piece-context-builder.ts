import { ActionContext, backwardCompatabilityContextUtils, CreateWaitpointHook, CreateWaitpointParams, CreateWaitpointResult, InputPropertyMap, Piece, PieceAuthProperty, PiecePropertyMap, SetScheduleRequest, StaticPropsValue, StopHookParams, TagsManager } from '@fema/connector-sdk'
