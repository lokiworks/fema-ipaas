...
import { ExecutionMode, WorkflowVersionState, NetworkMode } from '@fema/shared'
...
import { codeBuilder } from '../../../../../src/lib/cache/workflow/code/code-builder'
// eslint-disable-next-line import/first
...
function buildArtifact(packageJson: string) {
    return {
        name: 'step_1',
        workflowVersionId: `fv-${randomUUID()}`,
