import { PiecePropertyMap, StaticPropsValue, TriggerStrategy } from '@fema/connector-sdk'
import { assertEqual, isNil, isObject } from '@fema/core-utils'
import { EngineGenericError, EngineHttpResponse, ExecuteTriggerResponse, FlowTrigger, PieceTrigger, PropertySettings, TriggerHookType } from '@fema/shared'
