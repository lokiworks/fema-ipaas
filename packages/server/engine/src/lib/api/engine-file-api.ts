...
import { EngineFileNotFoundError, EngineGenericError, FileCompression, FileType, isZstdCompressed } from '@fema-ipaas/shared'
...
type UploadParams = {
    ...
    apiUrl: string
    fileId: string
    type: FileType.WORKFLOW_STEP_FILE | FileType.EXECUTION_LOG | FileType.EXECUTION_LOG_SLICE
    fileName?: string
