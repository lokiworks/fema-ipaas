...
To use the dev container for the FEMA Integration Platform project, follow these steps:

1. Clone the FEMA Integration Platform repository to your local machine.
