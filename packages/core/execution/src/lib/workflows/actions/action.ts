...
export const CodeActionSchema = z.object({
    ...commonActionProps,
    type: z.literal(WorkflowActionType.CODE),
...
export const LoopOnItemsActionSchema = z.object({
    ...commonActionProps,
    type: z.literal(WorkflowActionType.LOOP_ON_ITEMS),
...
export const WorkflowAction: z.ZodType<WorkflowAction> = z.lazy(() =>
    z.discriminatedUnion('type', [
        ...
        LoopOnItemsActionSchema.extend({
            nextAction: WorkflowAction.optional(),
            firstLoopAction: WorkflowAction.optional(),
        }),
        z.object({
            ...commonActionProps,
            type: z.literal(WorkflowActionType.ROUTER),
...
export const ContinueOnFailureBranches: z.ZodType<ContinueOnFailureBranches> = z.object({
    onSuccess: WorkflowAction.optional(),
    onFailure: WorkflowAction.optional(),
})
