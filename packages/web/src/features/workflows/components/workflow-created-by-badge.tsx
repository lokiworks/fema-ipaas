...
type WorkflowCreatedByBadgeProps = {
  createdBy: WorkflowCreator | null | undefined;
  className?: string;
};

export const WorkflowCreatedByBadge = ({
  createdBy,
  className,
}: WorkflowCreatedByBadgeProps) => {
  if (!createdBy || createdBy.type !== WorkflowCreatorType.MCP) {
    return null;
  }
