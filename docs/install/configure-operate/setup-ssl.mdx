---
title: "HTTPS"
description: "Terminate TLS with an Nginx reverse proxy, for self-hosters managing their own certificates"
icon: "shield"
---

<Note>
This tutorial is for self-hosters who terminate TLS themselves. **You can skip this page** if your environment already handles TLS for you — a managed host, a cloud load balancer, or a Kubernetes ingress.
</Note>
