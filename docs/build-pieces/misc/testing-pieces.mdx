...
For a full working example, see the [text-helper piece tests on GitHub](https://github.com/lokiworks/fema-ipaas/tree/main/packages/pieces/core/text-helper/test).
