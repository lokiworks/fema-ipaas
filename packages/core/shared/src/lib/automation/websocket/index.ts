import { StepRunResponse, UpdateStepProgressRequest } from '@fema-ipaas/workflow-core'
import { z } from 'zod'
...
export enum WebsocketClientEvent {
    ...
    REFRESH_CONNECTOR = 'REFRESH_CONNECTOR',
...
export type EmitTestStepProgressRequest = StepRunResponse & { workspaceId: string, sequence?: number }
