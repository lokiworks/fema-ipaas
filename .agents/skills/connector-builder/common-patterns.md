...
For connectors with many actions sharing API logic, create `src/lib/common/index.ts`:
...
**Real examples:**
- `packages/connectors/community/github/src/lib/common/index.ts`
- `packages/connectors/community/stripe/src/lib/common/index.ts`
...
**Real example:** `packages/connectors/community/github/src/lib/common/index.ts` -- `githubPaginatedApiCall`
