...
AI providers are configured by the platform admin to centrally manage credentials and access, making [AI connectors](https://github.com/lokiworks/fema-ipaas/connectors/ai) and their features available to everyone in all projects.
