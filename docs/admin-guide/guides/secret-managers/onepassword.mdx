---
title: "1Password"
description: "Connect 1Password to FEMA Integration Platform for centralized secret management"
---
...
3. Give it a name (e.g. `FEMA Integration Platform`).
4. Grant it **Read Items** access on the vaults FEMA Integration Platform needs to access.
...
## Step 2 — Connect in FEMA Integration Platform
...
FEMA Integration Platform will retrieve the secret value from 1Password and inject it into the connection at runtime.
