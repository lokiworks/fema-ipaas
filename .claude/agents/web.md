---
name: web
description: Frontend agent for the FEMA Integration Platform web application (packages/web). Specializes in React components, UI features, workflow builder, and frontend architecture.
model: sonnet
tools:
  - Read
  - Edit
