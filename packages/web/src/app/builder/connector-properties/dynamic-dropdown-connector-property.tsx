...
const DynamicDropdownConnectorPropertyImplementation = React.memo(
  (props: DynamicDropdownProps) => {
    ...
    const { mutate, isPending, error } = connectorsHooks.useConnectorOptions<
...
const DynamicDropdownConnectorProperty = React.memo(
  (props: DynamicDropdownProps) => {
    return (
      <DynamicPropertiesErrorBoundary>
        <DynamicDropdownConnectorPropertyImplementation {...props} />
      </DynamicPropertiesErrorBoundary>
    );
  },
);
DynamicDropdownConnectorProperty.displayName =
  'DynamicDropdownConnectorProperty';
DynamicDropdownConnectorPropertyImplementation.displayName =
  'DynamicDropdownConnectorPropertyImplementation';
export { DynamicDropdownConnectorProperty };
