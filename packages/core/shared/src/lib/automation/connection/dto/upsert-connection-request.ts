...
export const UpsertNoAuthRequest = z.object({
    ...commonAuthProps,
    type: z.literal(ConnectionType.NO_AUTH),
    value: z.object({
        type: z.literal(ConnectionType.NO_AUTH),
    }),
}).describe('No Auth')
...
export const UpsertCloudOAuth2Request = z.object({
    ...commonAuthProps,
    type: z.literal(ConnectionType.CLOUD_OAUTH2),
    value: z.object({
        ...commonOAuth2ValueProps,
        props: propsSchema.optional(),
        scope: z.string(),
...
export const UpsertSecretTextRequest = z.object({
    ...commonAuthProps,
    type: z.literal(ConnectionType.SECRET_TEXT),
    value: z.object({
        type: z.literal(ConnectionType.SECRET_TEXT),
...
export const UpsertOAuth2Request = z.object({
    ...commonAuthProps,
    type: z.literal(ConnectionType.OAUTH2),
    value: z.object({
        ...commonOAuth2ValueProps,
...
export const UpsertBasicAuthRequest = z.object({
    ...commonAuthProps,
    type: z.literal(ConnectionType.BASIC_AUTH),
    value: z.object({
...
export const UpsertConnectionRequestBody = z.union([
...
export type UpsertConnectionRequestBody = z.infer<typeof UpsertConnectionRequestBody>
